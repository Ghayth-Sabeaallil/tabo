                ...
                <div className="grid grid-rows-1 sm:grid-rows-2 grid-rows-2 p-4 gap-4 items-center">
                    <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 items-center gap-4">
                        ...
                        <div className="flex flex-col justify-center gap-4 border-4 rounded border-header p-2 bg-bg bg-opacity-40">
                            ...
                            <a href={`https://www.google.com/maps?q=${item.location?.lat},${item.location?.lng}`} target="_blank" rel="noopener noreferrer nofollow">
                                <div className="hover:bg-hoverBg border-2 cursor-pointer select-none border-black bg-header text-text text-xl sm:text-xl flex justify-center items-center gap-4 font-Amiri md:text-2xl font-extrabold p-2 rounded-xl">على الخريطة <FaLocationDot color="#BA9503" /></div></a>
                        </div>
                    </div>
