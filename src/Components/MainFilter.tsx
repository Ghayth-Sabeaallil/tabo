        ...
        <div className="animate-[animation_1s_ease-in] flex flex-col justify-center items-center h-full gap-10 mb-4 mt-10">
            ...
            <div className="flex flex-col sm:flex-col md:flex-row gap-10 justify-between items-center">
                <div className="flex flex-col gap-2 items-center font-Amiri font-black ">
                    <p className="text-4xl text-header">العقارات المعروضة للبيع</p>
                    <CountUp className="text-8xl" end={active} duration={5} delay={1} />
                </div>
                <div className="flex flex-col gap-2 items-center text-4xl font-Amiri font-black ">
                    <p className="text-4xl text-header">العقارات المباعة</p>
                    <CountUp className="text-8xl" end={unActive} duration={5} delay={1} />
                </div>
            </div>
        </div>
    )
