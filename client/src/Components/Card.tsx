    ...
    return (
        <>
            <div className="relative w-full h-[400px] border-2 border-text grid grid-rows-2 p-1 rounded-lg bg-card hover:bg-hoverBg hover:scale-95">
                {images && <img loading="lazy" className="object-cover w-full h-[200px] object-cover rounded-lg border-4 border-text" src={images.length > 0 ? images![0] : "https://res.cloudinary.com/dornqibbw/image/upload/v1739056445/logo_q5d8tl.png"} alt="primaryImage" />}
